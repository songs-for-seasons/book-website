...
<div id="reg_img" >
	...
	<div id="reg_ins" align="center">
		...
		<input id=reg_button type="submit" value="注册读者" />-->
		<button id=reg_button type="button" name="cancel" onclick="clickCancel()">取消注册</button>&nbsp;&nbsp;&nbsp;
		<button id=reg_button type="button" name="reg_w" onclick="return clickWriter(username,password,password_check)">注册作家</button>&nbsp;&nbsp;&nbsp;
		<button id=reg_button type="button" name="reg_r" onclick="return clickReader(username,password,password_check)">注册读者</button>
		</form>
	</div>
</div>
