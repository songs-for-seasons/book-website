...
<div id="reg_img">
	...
	<div id="reg_ins" align="center">
		<form action="Login" method="post" style="margin:0 0 0 0;">
		<label>用户ID：&nbsp;	<input class="reg_field" type="text" name="userid"/></label></br></br>
		...
		<!-- <button id=reg_button type="button" onclick="clickConfirm(userid, password)">确定</button> -->
		<input id=reg_button type="submit" onclick="return clickConfirm(userid, password)" value="登录">
		</form>
		</br>
		<div><a href="register.jsp" style="color:white;"><font size=4>新用户请点击注册</font></a></div>
	</div>
</div>
